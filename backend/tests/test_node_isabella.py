...
class TestIsabellaNode:
    ...
    def test_isabella_node_has_llm(self):
        """Test that IsabellaNode has LLM configured."""
    ...
    async def test_isabella_evaluate_returns_correct_keys(self):
        ...
        mock_result.dict.return_value = {
            "score": 90,
            "notes": "A masterpiece of elegance",
            "confidence": 0.95,
            "techniques_used": ["aesthetics_review"],
            "aspects": {"readability": 92, "elegance": 88},
        }

        with patch.object(IsabellaNode, "get_prompt") as mock_get_prompt:
...
class TestIsabellaPrompt:
    ...
    def test_isabella_prompt_contains_wine_critic_theme(self):
        ...
        with patch("app.graph.nodes.base.ChatGoogleGenerativeAI"):
            ...
            # Verify system message contains wine critic references
